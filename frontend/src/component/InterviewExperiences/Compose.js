...
const Compose = () => {
    ...
    const { loading, error, success } = useSelector((state) => state.interview);
    ...
    const submitInterview = (e) => {
        ...
        if (tags.length === 0) {
            ...
            dispatch(addNewInterview(myForm));
        }
    };
                        ...
                        <div className="card-body">
                            <div className="row">
                                <div className="col-12 text-center">
                                    <h3>Compose Interview Experience</h3>
                                    <h6 className="font-light m-t-0">Share details about the interview process you have been through..</h6>
                                </div>
                            </div>
                        </div>
                    </div>
