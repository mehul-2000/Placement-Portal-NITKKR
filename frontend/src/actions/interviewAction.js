...
export const addNewInterview = (interview) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post("https://placement-portal-liart.vercel.app/api/interview/add", interview, config);
...
export const editInterview = (interview) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post("https://placement-portal-liart.vercel.app/api/interview/edit", interview, config);
...
export const getAllInterviews = () => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get('https://placement-portal-liart.vercel.app/api/interview/getAll');
...
export const getAllAdminInterviews = () => async (dispatch) => {
    try{
        dispatch({type:GET_INTERVIEWS_REQUEST});
        const {data} = await axios.get('https://placement-portal-liart.vercel.app/api/interview/getAll_admin');
        dispatch({ type: GET_INTERVIEWS_SUCCESS, payload: data });
    } catch(error) {
        dispatch({
            type: GET_INTERVIEWS_FAIL,
...
export const getInterviewDetails = (interview_id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`https://placement-portal-liart.vercel.app/api/interview/getOne/${interview_id}`);
...
export const changeStatus = (experience_id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.post('https://placement-portal-liart.vercel.app/api/interview/changeStatus', {experience_id}, config);
